...
@section('title', 'Tour Listing Edit')
            ...
            <div class="in-content-wrapper">
                ...
                <div class="box">
                    ...
                    <div class="tour-listing-form">
                        <form class="text-center" method="POST" action="{{ route('listing-tour.update', $unit->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md">
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="city" required
                                            value="{{ $unit->city }}" id="inputGroupSelect03">
                                    </div><!-- end form-group -->
                                </div><!-- end column -->
                                <div class="col-md">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="seats" id="inputGroupSelect04">
                                                <option selected value="{{ $unit->seats }}">{{ $unit->seats }}</option>
                            ...
                            <div class="form-group">
                                <textarea class="form-control textarea text-start p-3" name="embed" id="exampleFormControlTextarea1"
                                    rows="5" placeholder="Embed Map">{{ $unit->embed }}</textarea>
                            </div><!-- end form-group -->

                            <div class="form-group">
                                <textarea class="form-control textarea text-start p-3" name="details" id="exampleFormControlTextarea1"
                                    rows="5" placeholder="Tour Details">{{ $unit->details }}</textarea>
                            </div><!-- end form-group -->
