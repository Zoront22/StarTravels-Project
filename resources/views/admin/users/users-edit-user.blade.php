            ...
            <div class="in-content-wrapper">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-4">
                        <div class="breadcrumb">
                            ...
                            <div class="breadcrumb-item active"><i class="fas fa-angle-right"></i>Edit User
                            </div>
                        </div><!-- end breadcrumb -->
                    </div><!-- End column -->
                ...
                <div class="box">
                    ...
                    <div class="hotel-listing-form">
                        <form class="text-center" action="{{ route('users.update', $user->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-sm-8">
                                        ...
                                        <div class="col-md">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control text-center" name="birth"
                                                    required value="{{ $user->birth }}" id="to7">
                                            </div><!-- end form-group -->
                                        </div><!-- End column -->
                                    </div><!-- end row -->
                                    ...
                                    <ul class="list-inline">
                                        <li class="list-inline-item">
                                            <button type="submit" class="btn" type="submit">Update User</button>
                                        </li>
                                        <li class="list-inline-item">
