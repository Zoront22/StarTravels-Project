										...
										<div class="row">
											...
											<div class="col-md">
												<div class="form-group">
													...
													<input type="email" class="form-control" required id="to3">
												</div><!-- end form-group -->
											</div><!-- End column -->
										</div><!-- end row -->
										<div class="row">
											<div class="col-md">
												<div class="form-group">
													...
													<input type="password" class="form-control" required id="to4">
												</div><!-- end form-group -->
											</div><!-- End column -->
											<div class="col-md">
												<div class="form-group">
										...
										<div class="row">
											<div class="col-md">
												<div class="form-group">
													...
													<input type="text" class="form-control" required id="to6">
												</div><!-- end form-group -->
											</div><!-- End column -->
											<div class="col-md">
												<div class="form-group">
													<label for="to7" class="">Date Of Birth:</label>
													<input type="date" class="form-control text-center" required id="to7">
												</div><!-- end form-group -->
											</div><!-- End column -->
										</div><!-- end row -->
