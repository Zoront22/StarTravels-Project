...
@section('title', 'Cruise Listing Edit')
            ...
            <div class="in-content-wrapper">
                ...
                <div class="box">
                    ...
                    <div class="cruise-listing-form">
                        <form class="text-center" method="POST" action="{{ route('listing-cruise.update', $unit->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md">
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="model" required
                                            value="{{ $unit->model }}" id="inputGroupSelect03">
                                    </div><!-- end form-group -->
                                </div><!-- end column -->
                            </div><!-- end row -->
                            <div class="row">
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="length" required
                                            value="{{ $unit->length }}" id="inputGroupSelect07">
                                    </div><!-- end form-group -->
                                </div><!-- end column -->
                            </div><!-- end row -->
                            <div class="row">
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cabins" required
                                            value="{{ $unit->cabins }}" id="inputGroupSelect10">
                                    </div><!-- end form-group -->
                                </div><!-- end column -->
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="crew" required
                                            value="{{ $unit->crew }}" id="inputGroupSelect11">
                                    </div><!-- end form-group -->
                                </div><!-- end column -->
                            </div><!-- end row -->
