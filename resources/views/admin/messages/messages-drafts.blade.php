						...
						<div class="table-responsive">
							<table class="table table-hover mx-auto">
								<tr class="unread">
									...
									<td>Draft</td>
									<td><a href="#">(no subject) - Kevin Welcome on LinkedIn.</a>
									</td>
								...
								<tr class="unread">
									...
									<td><i class="fas fa-gem"></i></td>
									<td>yahoo, Draft 3</td>
									<td><a href="#">(no subject) - Welcome To University Of Alaska Kevin</a></td>
									<td><i class="fa fa-paperclip"></i>
									</td>
									<td>Nov 19</td>
								</tr>
								<tr class="unread">
									...
									<td><i class="fas fa-gem"></i></td>
									<td>Draft</td>
									<td><a href="#">(no subject) - Fwd: Important Data Regarding To your Website</a></td>
									<td><i class="fa fa-paperclip"></i>
									</td>
									<td>Nov 17</td>
								</tr>
								<tr class="unread">
									...
									<td><i class="fas fa-gem"></i></td>
									<td>me, Draft 2</td>
									<td><a href="#">(no subject) - Hello Kevin! Apply now for MS</a></td>
									<td>
									</td>
									<td>Nov 16</td>
								</tr>
								<tr class="unread">
									...
									<td><i class="fas fa-gem"></i></td>
									<td>Draft</td>
									<td><a href="#">(no subject) - Transaction Alert For Your ABC Bank</a></td>
									<td><i class="fa fa-paperclip"></i>
									</td>
									<td>Nov 16</td>
								</tr>
