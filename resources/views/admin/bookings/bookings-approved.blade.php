...
@section('title', 'Bookings Aproved')
					...
					<div class="row no-gutters">
						...
						<div class="col-md-4">
							<div class="breadcrumb">
								...
								<div class="breadcrumb-item active"><i class="fas fa-angle-right"></i>Approved
								</div>
							</div><!-- End Breadcrumb -->
						</div><!-- End row -->
					</div><!-- End row -->
									...
									<tbody>
										...
										<tr>
											<td><img src="{{ asset('vendors/admin/images/commenter-1.jpg') }}" alt="table-img" class="img-fluid rounded-circle"
													width="40px"></td>
											<td>Amar</td>
											<td><a href="#">967335522</a></td>
											<td><a href="#">amar@gmail.com</a></td>
											<td>11/06/2019</td>
											<td>15/06/2019</td>
											<td>Hotel</td>
											<td class="approved"><a href="#">Approved</a></td>
										...
										<tr>
											<td><img src="{{ asset('vendors/admin/images/commenter-2.jpg') }}" alt="table-img" class="img-fluid rounded-circle"
													width="40px"></td>
											<td>Sarah Smith</td>
											<td><a href="#">938834442</a></td>
											<td><a href="#">Smith@gmail.com</a></td>
											<td>4/06/2019</td>
											<td>7/06/2019</td>
											<td>Tour</td>
											<td class="approved"><a href="#">Approved</a></td>
