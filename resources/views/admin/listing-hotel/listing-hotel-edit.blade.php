...
@section('title', 'Hotel Listing Edit')
            ...
            <div class="in-content-wrapper">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-4">
                        <div class="breadcrumb">
                            ...
                            <div class="breadcrumb-item active"><i class="fas fa-angle-right"></i>Modify
                            </div>
                        </div><!-- end breadcrumb-->
                    </div><!-- end column -->
                ...
                <div class="box">
                    ...
                    <div class="hotel-listing-form">
                        <form class="text-center" method="POST" action="{{ route('listing-hotel.update', $unit->id) }}">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="room" required
                                            value="{{ $unit->room }}" id="inputGroupSelect07">
                                    </div><!-- end form-group -->
                                </div><!-- end column -->
                                <div class="col-md">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="type" id="inputGroupSelect00">
                                                <option selected value="{{ $unit->type }}">{{ $unit->type }}</option>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="ac" id="inputGroupSelect01">
                                                <option selected value="{{ $unit->ac }}">{{ $unit->ac }}</option>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="meal" id="inputGroupSelect02">
                                                <option selected value="{{ $unit->meal }}">{{ $unit->meal }}</option>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select class="form-select" name="cancellation_charges" id="inputGroupSelect03">
                                                <option selected value="{{ $unit->cancellation_charges }}">
                                                    {{ $unit->cancellation_charges }}</option>
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="phone" required
                                            value="{{ $unit->phone }}" id="inputGroupSelect05">
                                    </div><!-- end form-group -->
                                </div><!-- end column -->
                                <div class="col-md">
                                    <div class="form-group">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="rent" required
                                                value="{{ $unit->rent }}" id="inputGroupSelect06">
                                        </div>
                                    </div><!-- end form-group -->
                                </div><!-- end column -->
                            </div><!-- end row -->
                            ...
                            <div class="form-group">
                                <textarea class="form-control textarea text-start p-3" name="details" id="exampleFormControlTextarea1"
                                    rows="5" placeholder="Room Details">{{ $unit->details }}</textarea>
                            </div><!-- end form-group -->
